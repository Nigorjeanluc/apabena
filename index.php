						...
						<div class="testimonialslide clearfix flexslider">
							<ul style="text-align:justify" class="slides">
								...
								heart full of love to support and accompany vulnerable children and families to prevent new cases of non-accompanied children in Rwanda.
									...
									<h4>Umuntu Ranaka <span>&#8213; Chairperson</span></h4> 
								</li>
								<li><blockquote>
								Fund mobilization through project proposals and partnership with foundations, government institutions, private entities and other generous people with willingness to 
								support vulnerable children.
									</blockquote>
									<h4>Mark Kanaka <span>&#8213; Vice-Chairperson </span></h4>
								</li>	
							</ul>
						</div>					
					</div>	
		...
		<div class="container">
				<div class="row">
								<div class="col-xs-6 col-md-2 aligncenter client">
                                    <div class="well" style="width:100%;height:100%">Advertisement Here</div>
