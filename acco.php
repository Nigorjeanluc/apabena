...
<head>
<meta charset="utf-8">
<title>Accomodation facilities | APABENA</title>
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Accomodation facilities</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<div class="widget">
					...
					<ul class="cat">
						<li><i class="fa fa-angle-right"></i><a href="bak.php">Bakery</a></li>
						<li><i class="fa fa-angle-right"></i><a href="carp.php">Carpentry</a></li>
						<li><i class="fa fa-angle-right"></i><a href="support.php">Support</a></li>
					</ul>
				</div>
				<!--<div class="widget">
